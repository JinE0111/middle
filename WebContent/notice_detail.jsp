        ...
        <div class="rigthMy">
            ...
            <div class="detailAll">
                <div class="detBot">
                    ...
                    <span class="detailList detPw"><%=nv.getNoticeName() %></span>
                </div>
                <div class="detBot">
                    <div class="detDiv detWir">
                        <span class="detailList detailId">작성자</span>
                        <span class="detailList detPwd"><%=nv.getAdId()%></span>
                    </div>
                    <div class="detDiv detDate">
                        <span class="detailList detailId">작성일</span>
                        <span class="detailList detPwd"><%=nv.getNoticeDate()%></span>
                    </div>
                </div>
                <div>
	                <textarea rows="20" cols="140" class="detailList detPw detCo" readonly><%=nv.getNoticeCon()%></textarea> 
                </div>
            </div>
